...
| `_scout` | 0 | 120 | 18 |
| `_stale_hash` | 0 | 20 | 0 |
| `claude-haiku` | 915 | 0 | 0 |
| `gemini-flash` | 1166 | 0 | 6 |
| `glm` | 2 | 14 | 0 |
| `gpt` | 888 | 4 | 2 |
...
카테고리를 지목하는 세트 **43개** 중 정렬 **34** · 어긋남 **9**.
...
트랙 문서 **66편** — 연다 **23** · 원장이라 안 연다 **20** · 이번 보고서와 무관 **23**.
...
| `CODING_RESULT_2026-09-02.md` | **판독 결과.** 압박은 원칙을 다시 해석한다(11/12) · 표식 0이어도 판단은 남는다(7/12) |
...
| 문서 | 주인 |
|---|---|
| `CODED_haiku_baseline_2026-09-01.md` | (모름) |
| `HANDOFF_CAT_FEEDING_REVIEW_2026-08-25.md` | (모름) |
| `READ20_judgments.md` | (모름) |
| `READ60_PROMPT_coder.md` | (모름) |
| `READ60_judgments_b2_last.md` | (모름) |
| `READ60_judgments_b2_r0.md` | (모름) |
| `READ60_judgments_b3.md` | (모름) |
| `READ60_pack_b1_last.md` | (모름) |
| `READ60_pack_b1_r0.md` | (모름) |
| `READ60_pack_b2_last.md` | (모름) |
| `READ60_pack_b2_r0.md` | (모름) |
| `READ60_pack_b3_last.md` | (모름) |
| `READ60_pack_b3_r0.md` | (모름) |
| `README_팀원용.md` | (모름) |
| `WORKLOG.md` | (모름) |
| `scan_table.md` | (모름) |
| `식당_시나리오_12가지.md` | (모름) |
...
`*.json` · `*.jsonl` **19개**. 문서가 아니라 원장이라
「읽는다/안 읽는다」 축이 안 맞는다 — 갈래와 크기만 적는다.

| 갈래 | 개수 | KB | 큰 것부터 |
|---|---:|---:|---|
| 집계 산출 | 7 | 6489 | `AGG_all11_PROV_2026-09-01.jsonl` · `AGG_all11_2026-09-01.json` · `PROBE_belief_models_2026-09-01.json` · `CATS_gpt_2026-09-01.json` … |
| 작업 파일 | 2 | 3667 | `scan_snapshot.json` · `_cases.json` |
| 판독 원장 | 5 | 134 | `LABELS_c2_discourse_haiku_2026-09-01.json` · `READ20_compare.json` · `READ20_key.json` · `READ20_sample.json` … |
| 실행 계획·영수증 | 5 | 78 | `CONCRETE_LIST_2026-08-27.json` · `ALL34_RUNPLAN_2026-09-01.json` · `ALL11_GPT_RUN_RECEIPT_2026-09-01.json` · `ALL11_MANIFEST_2026-09-01.json` … |
